...
<html lang="en">
  ...
  <section id="container" class="">
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu">                
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a class="" href="uploadcat.php">Upload category</a></li>                          
                          <li><a class="" href="uploadinfo.php">Upload Info</a></li>
                          <li><a class="" href="editinfo.php">Edit Info</a></li>
                      </ul>
                  </li>       
                  <li class="sub-menu">
                      <a href="javascript:;" class="">
      ...
      <section id="main-content">
          ...
          <div class="row">
                <div class="col-lg-12">
                    <h3 class="page-header"><i class="fa fa-file-text-o"></i> Edit</h3>
                    <ol class="breadcrumb">
                          ...
                          <div class="panel-body">
                              <form class="form-horizontal " method="POST">
                                  <div class="form-group">
                                      ...
                                      <div class="col-sm-10">
                                          <input type="text" class="form-control" name="titlename" value="<?php echo $name;?>">
                                      </div>
                                  </div>
                                  <div class="form-group">
                                  ...
                                  <div class="panel-body">
                                      <div class="form">
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <textarea class="form-control ckeditor" name="editortext" value="<?php echo $details;?>" rows="6"></textarea>
                                                  </div>
                                              </div>
                                      </div>
                                  </div>
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <input type="file" id="exampleInputFile3" name="picture" value="<?php echo $picture;?>">
