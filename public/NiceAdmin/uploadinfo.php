...
if (isset($_POST['submit'])) {
    ...
    $insertinfo = "INSERT INTO info (name, category, details, picture) VALUES ('{$tname}', '{$category}', '{$editortext}', '{$picture}')";
    $resultofinfo = mysqli_query($connect, $insertinfo);
}
                                  ...
                                  <div class="panel-body">
                                      <div class="form">
                                              <div class="form-group">
                                                  ...
                                                  <div class="col-sm-10">
                                                      <textarea class="form-control ckeditor" name="editortext" rows="6"></textarea>
                                                  </div>
                                              </div>
                                      </div>
                                  </div>
                                                  ...
                                                  <div class="form-group">
                                                      ...
                                                      <input type="file" id="exampleInputFile3" name="picture">
