...
<section id="main-content">
        ...
        <div class="col-lg-12">
          <h3 class="page-header"><i class=""></i>E-Banking</h3>
			  ...
			  <div class="row">
			  	<div class="col-lg-6"> 
			  		<div class="studentcircle"><img data-src="holder.js/300x200" class="img-responsive" style="width: 250px; height: 200px; border-radius: 10px;" src="<?php echo URLROOT;?>/images/<?php echo $data['user']->image?>" alt="No image..."/></div>
			  	</div>
			  	<div class="col-lg-6"> 
