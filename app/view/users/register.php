...
<div class="row register">
    <div class="col-md-6 mx-auto">
        <div class="card card-body bg-light mt-5 regopacity">
            <div class="signup">
                <h2>Sign up</h2>
                <p>register as a new user</p><hr>
            </div>
            <form action = "<?php echo URLROOT;?>/users/register" method="POST">
                <div class="form-group">
                    <label for="name">Name: <sup>*</sup></label>
                    <input type="text" name="name" class="form-control form-control-lg <?php echo (!empty($data['name_err'])) ? 'is-invalid' : ''; ?>" value="<?php echo $data['name'];?>"><span class="invalid-feedback"><?php echo $data['name_err'];?></span>
                </div>
                <div class="form-group">
