                  ...
                  <div class="col-lg-6 col-lg-offset-3">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="<?php echo URLROOT;?>/users/adduser" enctype="multipart/form-data">
                                      ...
                                      <div class="form-group">
                                          <label for="password" class="control-label col-lg-2">Confirm-Pass<span class="required">*</span></label>
                                          <div class="col-lg-10">
