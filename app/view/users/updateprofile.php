                  ...
                  <div class="col-lg-6 col-lg-offset-3">
                      <section class="panel">
                          ...
                          <div class="panel-body">
                              <div class="form">
                                  <form class="form-validate form-horizontal" id="feedback_form" method="POST" action="<?php echo URLROOT;?>/users/updateprofile/<?php echo $data['id'];?>" enctype="multipart/form-data">
                                      <div class="form-group">
                                          <label for="cemail" class="control-label col-lg-2">SurName<span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control <?php echo (!empty($data['surname_err'])) ? 'is-invalid' : ''; ?>" id="cemail" type="text" name="surname" readonly value="<?php echo $data['surname'];?>" required /><span class="invalid-feedback" style="color:red;"><?php echo $data['surname_err'];?></span>
                                          </div>
                                      </div>
                                      <div class="form-group">
                                          <label for="cemail" class="control-label col-lg-2">FirstName<span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control <?php echo (!empty($data['firstname_err'])) ? 'is-invalid' : ''; ?>" id="cemail" type="text" name="firstname" readonly value="<?php echo $data['firstname'];?>" required /><span class="invalid-feedback" style="color:red;"><?php echo $data['firstname_err'];?></span>
                                          </div>
                                      </div>
                                      <div class="form-group">
                                          <label for="cemail" class="control-label col-lg-2">E-Mail<span class="required">*</span></label>
                                          <div class="col-lg-10">
                                              <input class="form-control <?php echo (!empty($data['email_err'])) ? 'is-invalid' : ''; ?>" id="cemail" type="email" name="email" readonly value="<?php echo $data['email'];?>" required /><span class="invalid-feedback" style="color:red;"><?php echo $data['email_err'];?></span>
                                          </div>
                                      </div>
                                      <div class="form-group">
                                      ...
                                      <input type="radio" value="male" name="gender"> Male &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="radio" value="female" name="gender"> Female<br>
                                       ...
                                       <div class="form-group">
                                        ...
                                        <div class="form-group">
                                          ...
                                          <div class="col-lg-10">
                                              <input class="form-control <?php echo (!empty($data['pin_err'])) ? 'is-invalid' : ''; ?>" id="cemail" type="text" name="pin" value="" required /><span class="invalid-feedback" style="color:red;"><?php echo $data['pin_err'];?></span>
                                          </div>
                                        </div>   
                                      <div class="form-group">
